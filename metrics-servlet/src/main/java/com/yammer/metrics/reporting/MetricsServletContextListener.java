...
/**
 * A servlet context listener which shuts down the various thread pools when the
...
public class MetricsServletContextListener implements ServletContextListener {
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		final Object metricsRegistry = context
				.getAttribute(MetricsServlet.REGISTRY_ATTRIBUTE);
