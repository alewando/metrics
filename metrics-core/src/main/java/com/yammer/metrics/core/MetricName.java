...
public class MetricName implements Comparable<MetricName> {
	 ...
	 * 
	 * @param klass
	 *            the {@link Class} to which the {@link Metric} belongs
	 * @param name
	 ...
	 * 
	 * @param group
	 *            the group to which the {@link Metric} belongs
	 * @param type
	 *            the type to which the {@link Metric} belongs
	 * @param name
	 *            the name of the {@link Metric}
	 */
	...
	public MetricName(String group, String type, String name, String scope) {
		this(group, type, name, scope,
				createMBeanName(group, type, name, scope));
	}
	 ...
	 *            the scope of the {@link Metric}
	 * @param mBeanName
	 *            the 'ObjectName', represented as a string, to use when
	...
	public MetricName(String group, String type, String name, String scope,
		...
		if (group == null || type == null) {
			throw new IllegalArgumentException(
					"Both group and type need to be specified");
		}
		if (name == null) {
	...
	/**
	 * Returns the MBean name for the {@link Metric} identified by this metric
	 * name.
	 * 
	...
	private static String createMBeanName(String group, String type,
