...
/**
 * An abstract base class for all reporter implementations which periodically
 * poll registered metrics (e.g., to send the data to another service).
 */
public abstract class AbstractPollingReporter extends AbstractReporter
		implements Runnable {
	...
	/**
	 * Shuts down the reporter polling, waiting the specific amount of time for
	 * any current polls to complete.
	 * 
	 * @param timeout
	 *            the maximum time to wait
	 * @param unit
	 *            the unit for {@code timeout}
