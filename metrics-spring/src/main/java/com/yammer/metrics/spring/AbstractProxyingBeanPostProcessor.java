...
public abstract class AbstractProxyingBeanPostProcessor extends ProxyConfig
		implements BeanPostProcessor {

	private static final long serialVersionUID = -3482052668071169769L;

	private final ClassLoader beanClassLoader = ClassUtils
	...
	public Object postProcessAfterInitialization(Object bean, String beanName)
		...
		if (AopUtils.canApply(pointcut, targetClass)) {
			...
			final PointcutAdvisor advisor = new DefaultPointcutAdvisor(
