...
public class TimedMethodInterceptor implements MethodInterceptor,
	...
	public TimedMethodInterceptor(final MetricsRegistry metrics,
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		final TimerContext tc = timers.get(invocation.getMethod().getName())
				.time();
		try {
	...
	public void doWith(Method method) throws IllegalArgumentException,
		...
		final String timerName = (timed.name() == null || "".equals(timed
				.name())) ? methodName : timed.name();
		final Timer timer = metrics.newTimer(targetClass, timerName,
				timed.durationUnit(), timed.rateUnit());
